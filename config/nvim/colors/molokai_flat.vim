" Vim color file - molokai_flat
" Generated by http://bytefluent.com/vivify 2014-06-16
" flattened by Michael Schwegel
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
set t_Co=256
let g:colors_name = "molokai_flat"

hi IncSearch guifg=#C4BE89 guibg=#000000 guisp=#000000 gui=NONE ctermfg=White ctermbg=DarkRed cterm=NONE
...
hi StatusLineNC guifg=#808080 guibg=#080808 guisp=#080808 gui=NONE ctermfg=8 ctermbg=234 cterm=NONE
"hi CTagsMember -- no settings --
hi NonText guifg=#BCBCBC guibg=#3B3A32 guisp=#3B3A32 gui=NONE ctermfg=234 ctermbg=233 cterm=NONE
...
hi Identifier guifg=#e68217 guibg=NONE guisp=NONE gui=NONE ctermfg=166 ctermbg=NONE cterm=NONE
...
hi Normal guifg=#F8F8F2 guibg=#0f0f0f guisp=#0f0f0f gui=NONE ctermfg=250 ctermbg=233 cterm=NONE
...
hi Statement guifg=#e60051 guibg=NONE guisp=NONE gui=bold ctermfg=161 ctermbg=NONE cterm=bold
"hi SpellRare -- no settings --
"hi EnumerationValue -- no settings --
hi Comment guifg=#858585 guibg=NONE guisp=NONE gui=NONE ctermfg=59 ctermbg=NONE cterm=NONE
...
hi Number guifg=#814bab guibg=NONE guisp=NONE gui=NONE ctermfg=97 ctermbg=NONE cterm=NONE
...
hi CursorLine guibg=#1c1c1c guisp=#1c1c1c gui=NONE ctermbg=234 cterm=NONE
hi CursorLineNr ctermbg=234 ctermfg=250
...
hi PreProc guifg=#71b300 guibg=NONE guisp=NONE gui=NONE ctermfg=70 ctermbg=NONE cterm=NONE
...
hi VertSplit guifg=#080808 guibg=#080808 guisp=#080808 gui=bold ctermfg=233 ctermbg=233 cterm=bold
...
hi Type guifg=#55c4e6 guibg=NONE guisp=NONE gui=NONE ctermfg=74 ctermbg=NONE cterm=NONE
...
hi Constant guifg=#ae9eff guibg=NONE guisp=NONE gui=bold ctermfg=147 ctermbg=NONE cterm=bold
...
hi cursorim guifg=#696969 guibg=#918c8c guisp=#918c8c gui=NONE ctermfg=242 ctermbg=246 cterm=NONE
